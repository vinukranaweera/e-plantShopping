...
function ProductList({ onHomeClick }) {
  ...
  const handleAddToCart = (product) => {
    if (isItemInCart(product.name)) return; // Prevent duplicate add
      ...
      <div className="navbar" style={styleObj}>
        <div className="tag">
          <div className="luxury">
            ...
            <a href="/" onClick={(e) => handleHomeClick(e)}>
              {/* <button onClick={handleHomeClick} style={{ background: "none", border: "none", color: "white" }}></button> */}
              <div>
        ...
        <div style={styleObjUl}>
          <div>
            ...
            <button onClick={handlePlantsClick} style={styleA}>
              Plants
            </button>
            {/* </a> */}
          </div>
                    ...
                    (
                      ...
                      <div className="product-card" key={plantIndex}>
                        ...
                        <button
                          ...
                          disabled={isItemInCart(plant.name)} // Disable if in cart
                          style={{
                            backgroundColor: isItemInCart(plant.name)
                              ? "gray"
                              : "#4caf50ff",
                            cursor: isItemInCart(plant.name)
                              ? "not-allowed"
                              : "pointer",
                          }}
                        >
